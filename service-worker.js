...
const APP_SHELL = [
  ...
  'js/views/personal-cumpleanos.js',
  'js/views/personal-alertas.js',
  'js/views/personal-conductores.js',
  'js/views/personal-perfil.js',
  'js/views/personal-rotacion.js',
  'js/views/siniestros-transito.js',
  'js/views/parque-automotor.js',
  'js/views/alertas-vencimientos.js',
  'js/views/historial.js',
  'js/views/facturas.js',
  'js/views/actividades.js',
  'js/views/fondo-siniestros.js',
  'js/views/fondo-rendimientos.js',
  'js/views/lineas-celulares.js',
  'js/views/ayuda.js',
  'js/pwa-update.js',
  'js/pwa-install.js',
  'js/app.js',
